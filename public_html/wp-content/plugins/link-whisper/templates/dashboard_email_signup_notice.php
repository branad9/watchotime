...
if ($can_edit_posts && null !== $screen && 'dashboard' === $screen->base && ( (empty($dismissed) && !isset($signed_up[$user->ID])) || $force_show) ) {
        ?>
        <div class="wpil-email-signup-offer notice notice-info is-dismissible">
            ...
            <span class="wpil-email-signup-shoutout"><?php _e('Get a $10 off special coupon code for Link Whisper! You can use it now, or save it in your inbox for later. PLUS get all the best practices, tips, and tricks for using internal links to gain rankings and traffic!', 'wpil'); ?></span>
